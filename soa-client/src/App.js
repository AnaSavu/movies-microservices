...
import MovieLecturePage from "./pages/movie club/movie-lecture.page";
        ...
        <div>
          {this.state.currentUser &&
            <nav className="navbar navbar-expand navbar-dark bg-dark">
              ...
              <Link to="/home" className="nav-item nav-link">
                ...
                <Link to="/movie-club" className="nav-item nav-link">
                  <FontAwesomeIcon icon={faNewspaper}/> Movie club
                </Link>
          ...
          <div className="container">
            <Switch>
              ...
              <Route exact path="/movie-club" component={MovieLecturePage}/>
