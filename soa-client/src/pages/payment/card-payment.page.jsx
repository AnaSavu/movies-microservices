...
export default class CardPaymentPage extends React.Component {
    ...
    handleSubmit = e => {
        ...
        MovieService.findMovieById(id).then(movie =>{
            var order = new Order(UserService.currentUserValue.id, movie.data);
            MovieService.createOrder(order).then(data => {
                this.setState({infoMessage: 'You bought the movie successfully.'});
